...
module.exports = {
    ...
    CreateAnUserValidator: [
        ...
        body('username')
            ...
            .bail()
            .isAlphanumeric().withMessage("username khong duoc chua ki tu dac biet"),
        ...
        body('role')
            ...
            .bail()
            .isMongoId().withMessage("role phai la ID"),

        body('avatarUrl')
            .optional()
            .isArray().withMessage("hinh anh khong hop le"),

        body('avatarUrl.*')
            .optional()
            .isURL().withMessage("URL khong hop le")
    ],
    ...
    ModifyAnUserValidator: [
        ...
        body('username')
            .isEmpty().withMessage("username khong duoc cap nhat"),

        body('_id')
            .isEmpty().withMessage("_id khong duoc cap nhat"),
